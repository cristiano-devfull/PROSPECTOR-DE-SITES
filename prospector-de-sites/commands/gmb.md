...
Execute o diagnóstico e otimização do Google Meu Negócio seguindo a skill `gmb`.
...
Gere o arquivo `gmb-[slug-cliente].md` na pasta conectada com:
...
A entrega final DEVE incluir confirmação "GMB gerado: gmb-[slug-cliente].md" e sugerir o próximo passo: `/proposta` para vender o pacote site + GMB ao cliente.
